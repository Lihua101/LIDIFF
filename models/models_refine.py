...
class RefineDiffusion(LightningModule):
    def __init__(self, hparams:dict, data_module: LightningDataModule = None):
        ...
        self.model_refine = minknet.MinkUNet(in_channels=23, out_channels=23*self.hparams['train']['up_factor'])
    ...
    def training_step(self, batch, batch_idx):
        ...
        x_coord[:,1:] = torch.round(x_feats[:,1:4] / self.hparams['data']['resolution'])
        ...
        offset = self.forward_refine(x_t).reshape(-1,self.hparams['train']['up_factor'],23)
